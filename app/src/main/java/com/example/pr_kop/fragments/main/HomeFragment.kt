...
import com.example.pr_kop.databinding.FragmentHomeBinding
...
class HomeFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        with(binding){
            ...
            val adapter = ProductAdapter(userViewModel.data.value!!.productList,true,object :ProductAdapter.Listener{
